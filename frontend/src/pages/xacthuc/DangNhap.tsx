...
export default function DangNhap() {
  ...
  return (
    <main className="auth-page auth-page--login auth-page-runtime min-h-dvh bg-[#f4f7fb] text-slate-950">
      <div className="auth-shell auth-shell-runtime grid min-h-dvh lg:grid-cols-[minmax(0,1.05fr)_minmax(440px,0.95fr)]">
        ...
        <section className="auth-panel-wrap auth-panel-wrap-runtime flex min-h-dvh items-center justify-center px-4 py-8 sm:px-6 lg:px-10">
          <div className="auth-panel auth-panel-runtime w-full max-w-[560px] rounded-[2rem] border border-slate-200 bg-white p-5 shadow-2xl shadow-slate-900/10 sm:p-8 lg:p-10">
